export const Initiatives = [
	...
	},
	{
		...
		description:
			'E-Cell NITA is proud to introduce our newest addition to Carpediem, a content writing and design competition. To nurture the talent among the community of students by encouraging them into writing and designing their content all on their own. Participants will also learn about market and product research.',
	},
	{
		title: 'DEAL-A-THON',
		date: '28th January 2023',
		description:
			'This is a trade competition involving traders and buyers who will be members of E-cell. The participants will be acting as the middle-man or the sales analysts .The participants will have to convince both the traders and buyers and make deals happen between them .The participants will basically be freelancing and working with multiple buyers and traders.',
	},
];
